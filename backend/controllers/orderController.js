...
const placeOrderStripe = async (req, res) => {
    try {
        ...
        const session = await stripe.checkout.sessions.create({
            // after completing payment, will be redirected to orders page but with this success url if payment is successful
...
const verifyStripe = async (req,res) => {
    ...
    try {
        if(success === "true") {
            ...
            await userModel.findByIdAndUpdate(userId, {cartData: {}}); // empty cart after placing order

    ...
    try {
      ...
      for(const items in cartItems) {
        for(const item in cartItems[items]) {
          if (cartItems[items][item] > 0) { // product in cart > 0 - recall data base saves cart item even if quantity 0
    ...
    <form onSubmit={onSubmitHandler} className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t'>
      ...
      <div className='flex flex-col gap-4 w-full sm:max-w-[480px]'>
        ...
        <div className='flex gap-3'>
          ...
          <input required onChange={onChangeHandler} name='province' value={formData.province} className='border border-gray-300 rounded py-1.5 px-3.5 w-full' placeholder='Province' type="text"  />
        </div>
         <div className='flex gap-3'>
          <input required onChange={onChangeHandler} name='postalCode' value={formData.postalCode} className='border border-gray-300 rounded py-1.5 px-3.5 w-full' placeholder='Postal Code' type="text"  />
        ...
        <input required onChange={onChangeHandler} name='number' value={formData.number} className='border border-gray-300 rounded py-1.5 px-3.5 w-full' placeholder='Phone' type="number"  />
      </div>
       {/* Right Side */}
        <div className='mt-8'>
